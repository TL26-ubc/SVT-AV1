...
typedef struct PluginCallbacks {
    void (*user_get_deltaq_offset)(SuperBlockInfo *sb_info_array, int *offset_array, uint32_t sb_count, int32_t frame_type, 
        int64_t picture_number, int frames_to_key, int frames_since_key, int64_t buffer_level);
